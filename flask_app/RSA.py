...
if __name__ == '__main__':
    print(encoder("upload", 509, 521, 17))
    print(decoder("149448, 246272, 256490, 197831, 118058, 163098,"
                  " 181455, 63076, 924, 75489, 97523, 239630, 110625, 59065, 233671", 509, 521, 17))
